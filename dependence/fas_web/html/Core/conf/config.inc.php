...
*/
	...
	//请配置用户注册地址
	$cfg['cfg']['reg'] = 'http://192.168.1.1:1234/user/reg.php';
	...
	//自动在地址中附加了用户名和密码
	$cfg['cfg']['userCenter'] = 'http://192.168.1.1:1234/user/index.php?user='.$_GET['username'].'&pass='.$_GET['password'];
	
	
	//请配置点击流量详情时进入的页面
	$cfg['cfg']['info'] = 'http://192.168.1.1:1234/user/index.php?user='.$_GET['username'].'&pass='.$_GET['password'];
	
	
	
	//详细配置参数

	$_SERVER['app_key']['cfg'] = "请在此输入32位的授权加密码";
