...
<section class="center-nav" ><div class="menu-wrapper " >
<div class="menu center-block" ><i class="iconfont icon-ticket-filled menu-icon" ></i>
<span class="title" >流量剩余</span>
<div class="pull-right" >
<span class="value-wrap" ><span class="value" ><?php echo round(($res['maxll']-$res['isent']-$res['irecv'])/1024/1024);?></span><span> MB</span></span>
<i class="iconfont icon-arrow-right trigger-icon" ></i></div></div>
</div>
<div class="menu-wrapper " >
<div class="menu center-block" ><i class="iconfont icon-sandglass-filled menu-icon" ></i><span class="title" >套餐总额</span><div class="pull-right" ><span class="value-wrap" ><span class="value" ><?php echo round($res['maxll']/1024/1024);?></span><span > MB</span></span><i class="iconfont icon-arrow-right trigger-icon" ></i></div></div>
</div>

<div class="menu-wrapper cash" ><div class="menu center-block" ><i class="iconfont icon-coupon-filled menu-icon" ></i><span class="title" >剩余时长</span><div class="pull-right" ><span class="value-wrap" ><span class="value" ><?php echo round(($res['endtime']-time())/86400);?></span><span > 天</span></span>
<i class="iconfont icon-arrow-right trigger-icon" ></i>
</div></div></div>
<div class="menu-wrapper yinhua" >
<div class="menu center-block" ><i class="iconfont icon-coin-filled menu-icon" ></i><span class="title" >发送数据</span><div class="pull-right" ><span class="value-wrap" ><span class="value" ><?php echo round($res['isent']/1024/1024);?></span><span > MB</span></span>
...
<div class="menu-wrapper card" >
	...
	<div class="pull-right" ><span class="value-wrap" ><span class="value" ><?php echo round($res['irecv']/1024/1024);?></span><span > MB</span></span><i class="iconfont icon-arrow-right trigger-icon" ></i></div></div></div>
